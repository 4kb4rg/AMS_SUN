...
Public Class BD_ImMatureCrop_Det : Inherits Page
    ...
    Sub onload_GetLangCap()
        ...
        End If
        dgUnMatureCropDet.Columns(1).HeaderText = GetCaption(objLangCap.EnumLangCap.Account) & lblCode.Text
    End Sub
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_UNMATURECROP_DET_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_UnMatureCrop_Details.aspx?blk=" & hidBlkCode.Value & "&yr=" & Request.QueryString("yr"))
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_UNMATURECROP_DET_GET&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_UnMatureCrop_Details.aspx")
        End Try
    ...
    Sub GetAreaStmtTotalArea()
        ...
        If objSysCfg.mtdHasConfigValue(objSysCfg.mtdGetConfigSetting(objSysCfg.EnumConfig.BlockCostLevel), intConfigsetting) = True Then
            ...
            strParam = objGLSetup.EnumBlockType.InMatureField & "|" & objGLSetup.EnumBlockStatus.Active & "|" & strLocation & "|" & hidBlkCode.Value & "|"
        Else
            strOppCd_UnMatureCrop_CostPerArea_SUM = "BD_CLSTRX_MATURECROP_SUBBLKTOTALAREA_GET"
            strParam = objGLSetup.EnumSubBlockType.InMatureField & "|" & objGLSetup.EnumSubBlockStatus.Active & "|" & strLocation & "|" & hidBlkCode.Value & "|"
        End If
        ...
        lblTotalAreaFig.Text = objGlobal.GetIDDecimalSeparator(FormatNumber(Trim(dsTotalArea.Tables(0).Rows(0).Item("AreaSize")), 0))
    ...
    Protected Function GetActivePeriod(ByRef BGTPeriod As String) As String
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_UNMMATURECOPDET_GET_BUDGETACTIVEPERIODS&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_UnMatureCrop_Details.aspx")
        End Try
    ...
    Sub Recalc_Formula()
        ...
        strParam = "|" & strLocation & "|" & GetActivePeriod("") & "|" & hidBlkCode.Value & "|MC.UnMatureCropSetID ASC"
        Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_UNMATURECROP_DET_RECALC_FORM_GET&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_UnMatureCrop_Details.aspx")
        End Try
        BindGrid()
