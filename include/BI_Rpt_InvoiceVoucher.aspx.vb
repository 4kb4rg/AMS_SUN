...
Public Class BI_Rpt_InvoiceVoucher : Inherits Page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        ReportFileName = "BI_Rpt_InvoiceVoucher.rpt"
        ...
        For intCount As Integer = 0 To objRptDs.Tables(0).Rows.Count - 1
            With objRptDs.Tables(0)
                ...
                .Rows(intCount).Item("Terbilang") = REPLACE(LEFT(ltrim(lCase(objGlobal.TerbilangDesimal(Replace(strTotal, ",", ""), "Rupiah"))), 1), LEFT(ltrim(lCase(objGlobal.TerbilangDesimal(Replace(strTotal, ",", ""), "Rupiah"))), 1), UCase(LEFT(ltrim(lCase(objGlobal.TerbilangDesimal(Replace(strTotal, ",", ""), "Rupiah"))), 1))) + MID(ltrim(lCase(objGlobal.TerbilangDesimal(Replace(strTotal, ",", ""), "Rupiah"))), 2, LEN(ltrim(lCase(objGlobal.TerbilangDesimal(Replace(strTotal, ",", ""), "Rupiah")))) - 1)
            End With
        Next
