...
Public Class BD_VehType_List : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=BD_TRX_VEHRUN_VEHTYPE&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_VehRun_VehType.aspx")
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        SearchStr = " AND veh.Status like '" & objGLSetup.EnumVehTypeStatus.Active & "'" ' AND veh.LocCode = '" & strLocation & "'"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GL_SETUP_VEHICLETYPE_GET&errmesg=" & lblErrMessage.Text & "&redirect=GL/Trx/BD_trx_VehRun_VehType.aspx")
        End Try
        Return objDataSet
    End Function
    ...
    Protected Function GetActivePeriod(ByRef BGTPeriod As String) As String
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=GET_BUDGETACTIVEPERIODS&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_VehRun_VehType.aspx")
        End Try
    ...
    Sub btnType_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Response.Redirect("../../BD/Trx/BD_Trx_VehRun_List.aspx?typ=" & strtype.Trim)
    End Sub
