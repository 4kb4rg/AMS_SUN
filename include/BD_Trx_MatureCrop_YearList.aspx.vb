...
Public Class BD_MatureCrop_Year : Inherits Page
    ...
    Sub onload_GetLangCap()
        ...
        lblTitle.Text = "MATURE CROP ACTIVITY"
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_MATURECROP_YEARLIST_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_MatureCrop_YearList.aspx")
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        Else
            strOppCd_GET = "BD_CLSTRX_CROPDIST_SUBBLOCK_GET"
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_MATURECROP_YEARLIST_GET&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_MatureCrop_YearList.aspx")
        End Try
    ...
    Sub btnBlockYear_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim strOppCd_Formula_GET As String = "BD_CLSTRX_CALCFORMULA_GET"
        ...
        Try
            intErrNo = objBDTrx.mtdUpdMatureCrop(strOppCd_MatureCrop_Format_GET, _
                                                 ...
                                                 True)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_MATURECROP_YEARLIST_BLK_ADD&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_MatureCrop_YearList.aspx")
        End Try
        ...
        Else
            Response.Redirect("../../BD/Trx/BD_Trx_MatureCrop_Det_DistByBlock.aspx?distbyblk=true&blk=" & strBlk.Trim & "&subblk=" & strSubBlk.Trim & "&yr=" & strYear.Trim)
        End If
    ...
    Sub btnSubBlockYear_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            intErrNo = objBDTrx.mtdUpdMatureCrop(strOppCd_MatureCrop_Format_GET, _
                                                ...
                                                False)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_MATURECROP_YEARLIST_SBLK_ADD&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_MatureCrop_YearList.aspx")
        End Try
        ...
        ElseIf intError = objBDTrx.EnumErrorType.BlockErr Then
            lblBlockErr.Visible = True
        Else
            Response.Redirect("../../BD/Trx/BD_Trx_MatureCrop_Details.aspx?distbyblk=false&blk=" & strBlk.Trim & "&subblk=" & strSubBlk.Trim & "&yr=" & stryear.Trim)
        End If
