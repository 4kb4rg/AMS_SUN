...
Public Class BD_MatureCropDist_Year : Inherits Page
    ...
    Sub GetEntireLangCap()
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_MATURECROPDIST_BlockList_GET_LANGCAP&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_MatureCropDist_YearList.aspx")
        End Try
    ...
    Protected Function LoadData() As DataSet
        ...
        If objSysCfg.mtdHasConfigValue(objSysCfg.mtdGetConfigSetting(objSysCfg.EnumConfig.BlockCostLevel), intConfigsetting) = True Then
            strOppCd_GET = "BD_CLSTRX_MATURECROPDIST_YEARPLANTED_BLK_GET"
        Else
            strOppCd_GET = "BD_CLSTRX_MATURECROPDIST_YEARPLANTED_SBLK_GET"
        End If

        strParam = "|" & strLocation & "|" & GetActivePeriod("") & "|||"
        Try
            intErrNo = objBDTrx.mtdGetMatureCrop(strOppCd_GET, strParam, objDataSet)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_MATURECROPDIST_BlockList_GET&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_MatureCropDist_YearList.aspx")
        End Try
    ...
    Protected Function GetActivePeriod(ByRef BGTPeriod As String) As String
        ...
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_MATURECROPDIST_GET_BUDGETACTIVEPERIODS&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_MatureCropDist_YearList.aspx")
        End Try
    ...
    Sub btnBlockYear_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim strOppCd_MatureCropDist_GET As String = "BD_CLSTRX_MATURECROPDIST_GET"
        Dim strOppCd_MatureCropDist_ADD As String = "BD_CLSTRX_MATURECROPDIST_ADD"
        Dim strOppCd_MatureCropSetup_AccCode_GET As String = "BD_CLSTRX_MATURECROPSETUP_ACCCODE_GET"
        Dim strOppCd_MatureCropDist_YrBudgetCost_SUM As String = "BD_CLSTRX_MATURECROPDIST_YRBUDGETCOST_SUM"
        Dim strOppCd_MatureCropDist_AccPeriod_ADD As String = "BD_CLSTRX_MATURECROPDIST_ACCPERIOD_ADD"
        ...
        Dim strOppCd_SubBlock_Get = "BD_CLSTRX_MATURECROP_DISTBYBLOCK_SUBBLOCK_GET"
        ...
        Try
            intErrNo = objBDTrx.mtdAddMatureCropDist(strOppCd_MatureCropDist_GET, _
                                                     strOppCd_MatureCropDist_ADD, _
                                                     strOppCd_MatureCropSetup_AccCode_GET, _
                                                     strOppCd_MatureCropDist_YrBudgetCost_SUM, _
                                                     strOppCd_MatureCropDist_AccPeriod_ADD, _
                                                     strOppCd_MatureCropDist_AccPeriod_UPD, _
                                                     ...
                                                     True)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_MATURECROPDIST_BLK_ADD&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_MatureCropDist_YearList.aspx")
        End Try

        If intError = objBDTrx.EnumErrorType.NoActivePeriod Then
            lblPeriodErr.Visible = True
        Else
            Response.Redirect("../../BD/Trx/BD_Trx_MatureCropDist_Details.aspx?distbyblk=true&blkcode=" & strBlkCode & "&subblkcode=" & strSubBlkCode.Trim & "&yr=" & stryear.Trim)
        End If
    End Sub
    ...
    Sub btnSubBlockYear_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            intErrNo = objBDTrx.mtdAddMatureCropDist(strOppCd_MatureCropDist_GET, _
                                                     ...
                                                     False)
        Catch Exp As System.Exception
            Response.Redirect("../../../include/mesg/ErrorMessage.aspx?errcode=BD_TRX_MATURECROPDIST_SUBBLK_ADD&errmesg=" & lblErrMessage.Text & "&redirect=BD/Trx/BD_trx_MatureCropDist_YearList.aspx")
        End Try

        If intError = objBDTrx.EnumErrorType.NoActivePeriod Then
            lblPeriodErr.Visible = True
        Else
            Response.Redirect("../../BD/Trx/BD_Trx_MatureCropDist_Details.aspx?distbyblk=false&blkcode=" & strBlkCode & "&subblkcode=" & strSubBlkCode.Trim & "&yr=" & stryear.Trim)
        End If
    End Sub
