...
Public Class CT_data_upload : Inherits Page
    ...
    Sub UploadBtn_Click(Sender As Object, E As ImageClickEventArgs)
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=CT_GET_FTPPATH&errmesg=" & lblErrMesage.Text & "&redirect=ct/data/ct_data_upload.aspx")
        End Try        
        ...
        If objGlobal.mtdValidateUploadFileName(strZipName, objGlobal.EnumDataTransferFileType.CT_CanteenReferenceData, strErrMsg) = False Then
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=CT_SAVEAS&errmesg=" & lblErrUpload.Text & "&redirect=ct/data/ct_data_upload.aspx")
        End Try
        ...
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=CT_DECRYPT_REF&errmesg=" & lblErrMesage.Text & "&redirect=ct/data/ct_data_upload.aspx")
        End Try
        ...
        Try
            intErrNo = objCTData.mtdUploadRef(strXmlPath)
        Catch Exp As System.Exception
            Response.Redirect("/include/mesg/ErrorMessage.aspx?errcode=CT_UPLOAD_REF&errmesg=" & lblErrMesage.Text & "&redirect=ct/data/ct_data_upload.aspx")
        End Try
