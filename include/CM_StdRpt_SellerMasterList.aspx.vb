...
Public Class CM_StdRpt_SellerMasterList : Inherits Page
    ...
    Sub BindStatusList()
        ...
        lstStatus.Items.Add(New ListItem(objCMSetup.mtdGetSellerStatus(objCMSetup.EnumSellerStatus.All), objCMSetup.EnumSellerStatus.All))
        lstStatus.Items.Add(New ListItem(objCMSetup.mtdGetSellerStatus(objCMSetup.EnumSellerStatus.Active), objCMSetup.EnumSellerStatus.Active))
        lstStatus.Items.Add(New ListItem(objCMSetup.mtdGetSellerStatus(objCMSetup.EnumSellerStatus.Deleted), objCMSetup.EnumSellerStatus.Deleted))
    ...
    Sub btnPrintPrev_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        strSellerCode = Server.UrlEncode(strSellerCode)
        ...
        Try
            intErrNo = objSysCfg.mtdGetConfigInfo(strParam, _
                                                  ...
                                                  objSysCfgDs)
        Catch Exp As System.Exception
            Response.Redirect("../../include/mesg/ErrorMessage.aspx?errcode=WM_STDRPT_Seller_MASTER_GET_CONFIG_DATE&errmesg=" & lblErrMessage.Text & "&redirect=../en/reports/WM_StdRpt_Selection.aspx")
        End Try
        ...
        If Not (strDateFrom = "" And strDateTo = "") Then
           ...
           Response.Write("<Script Language=""JavaScript"">window.open(""CM_StdRpt_SellerMasterListPreview.aspx?Type=Print&Location=" & strUserLoc & "&RptID=" & strRptID & "&RptName=" & strRptName & "&Decimal=" & "" & _
                           "&DateFrom=" & objDateFrom & "&DateTo=" & objDateTo & "&SellerCode=" & strSellerCode  & "&Name=" & strName & "&Telephone=" & strTelephone & "&UpdatedBy=" & strUpdatedBy  & _
