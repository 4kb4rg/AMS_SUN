...
Public Class CT_Rpt_CanteenItemMaster : Inherits page
    ...
    Sub Bind_Report()
        ...
        Dim strOpCd As String = "IN_CLSSETUP_INVMASTER_LIST_GET_FOR_REPORT"
		...
		strSearch =  "AND ItemType = '" & objCT.EnumInventoryItemType.CanteenItem & "' AND itm.Status like  '" & IIF(Not strStatus = "", strStatus, "%" ) &"' "
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\CT\Reports\Crystal\CT_Rpt_CanteenItemMaster.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        crDiskFileDestinationOptions.DiskFileName = objMapPath & "web\ftp\CT_Rpt_CanteenItemMaster.pdf"
        ...
        Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/CT_Rpt_CanteenItemMaster.pdf"">")
