...
Public Class BD_Rpt_FFBReceivedList : inherits page
    ...
    Public Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strSuppCode = Trim(Request.QueryString("strSuppCode"))
        strFFBWeight = Trim(Request.QueryString("strFFBWeight"))
        ...
        SuppCodeTag = Trim(Request.QueryString("SuppCodeTag"))
        FFBWeightTag = Trim(Request.QueryString("FFBWeightTag"))
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        Dim strOpCd As String = "BD_CLSTRX_FFB_RECEIVED_LIST_GET_FOR_REPORT"
        ...
        If NOT strSuppCode = "" Then
            strSearch = strSearch & " AND BD.SupplierCode like '" & _
                        strSuppCode & "%' "
        End If
        
        If NOT strFFBWeight = "" Then
            strSearch = strSearch & " AND BD.FFBWeight like '" & _
                        strFFBWeight & "%' "
        End If
        ...
        Try
            intErrNo = objBD.mtdGetFFBReceivedList(strOpCd, strParam, objRptDs)
        ...
        For intCnt=0 To objRptDs.Tables(0).Rows.Count - 1
            objRptDs.Tables(0).Rows(intCnt).Item("Status") = objBD.mtdGetFFBReceiveStatus(objRptDs.Tables(0).Rows(intCnt).Item("Status"))
        ...
        rdCrystalViewer.Load(objMapPath & "Web\EN\BD\Reports\Crystal\BD_Rpt_FFBReceivedList.rpt", OpenReportMethod.OpenReportByTempCopy)
        ...
        Else
            ...
            DiskOpts.DiskFileName = objMapPath & "web\ftp\BD_Rpt_FFBReceivedList.pdf"
            rdCrystalViewer.ExportOptions.DestinationOptions = DiskOpts
            rdCrystalViewer.Export()

            Response.Write("<META HTTP-EQUIV=""refresh"" CONTENT=""0; URL=../../../ftp/BD_Rpt_FFBReceivedList.pdf"">")
        End If
    ...
    Sub PassParam()
        ...
        paramField3 = ParamFields.Item("SuppCodeTag")
        paramField4 = ParamFields.Item("FFBWeightTag")
        ...
        ParamDiscreteValue3.value = SuppCodeTag
        ParamDiscreteValue4.value = FFBWeightTag
