...
Public Class CB_Rpt_ChequeGiroPrint : Inherits page
    ...
    Sub Bind_ITEM(ByVal blnIsPDFFormat As Boolean)
        ...
        If TRXType = "CASHBANK" Then
            ...
            strOpCd_Get = "CB_CLSTRX_CASHBANKPAY_GET_FOR_DOCRPT_CHEQUEGIRO" & "|" & "CashBank"
            strOpCd_GetLine = "CB_CLSTRX_CASHBANKPAY_LINE_GET_FOR_DOCRPT_CHEQUEGIRO" & "|" & "CashBankLn"
        ...
        ElseIf TRXType = "PAYMENT" Then
            strOpCd_Get = "CB_CLSTRX_PAYMENT_GET_FOR_DOCRPT_CHEQUEGIRO" & "|" & "CashBank"
            strOpCd_GetLine = "CB_CLSTRX_PAYMENT_LINE_GET_FOR_DOCRPT_CHEQUEGIRO" & "|" & "CashBankLn"
        ...
        If objRptDs.Tables(0).Rows.Count > 0 Then
            ...
            If strCBType = "3" Then
                If objRptDs.Tables("CashBankLn").Rows.Count > 0 Then
                    arrTotalAmount(0) = CDbl(arrTotalAmount(0)) - CDbl(objRptDs.Tables("CashBankLn").Rows(0).Item("Total"))
                End If
            End If
            ...
            If TRXType = "CASHBANK" Then
                ...
                strOpCode = "CB_CLSTRX_CASHBANKPAY_LINE_GET_FOR_DOCRPT_CHEQUEGIRO"
            Else
